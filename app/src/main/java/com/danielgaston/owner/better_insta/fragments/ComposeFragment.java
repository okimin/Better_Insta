...
import com.danielgaston.owner.better_insta.MainActivity;
...
public class ComposeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnTakePic= view.findViewById(R.id.btnPicture);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(photoFile ==null || ivPic.getDrawable()==null){
                    Toast.makeText(getContext(), "Photo not submitted", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void savePost(String description, ParseUser currentUser, File photoFile) {
        ...
        post.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if (e != null) {
                    Toast.makeText(getContext(), "Issue With Posting", Toast.LENGTH_SHORT).show();
                    return;
                }
