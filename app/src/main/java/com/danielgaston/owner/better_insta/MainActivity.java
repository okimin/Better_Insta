...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTakePic= findViewById(R.id.btnPicture);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(photoFile ==null || ivPic.getDrawable()==null){
                    Toast.makeText(MainActivity.this, "Photo not submitted", Toast.LENGTH_SHORT).show();
                    return;
                }
      ...
      post.setImage(new ParseFile(photoFile));
        post.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if (e!=null){
                    Toast.makeText(MainActivity.this,"Issue With Posting",Toast.LENGTH_SHORT).show();
                    return;
                }
